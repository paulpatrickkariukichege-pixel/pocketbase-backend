/**
 * Initial database schema migration for Ndunyu POS
 */
migrate((db) => {
    const dao = new Dao(db);
    
    // app_users - Our custom user collection
    ...
    inventoryItems.fields.add(new TextField({ name: "name", required: true }));
    inventoryItems.fields.add(new TextField({ name: "compatibility", required: false }));
    inventoryItems.fields.add(new NumberField({ name: "buying_price", required: true }));
    inventoryItems.fields.add(new NumberField({ name: "target_selling_price", required: true }));
    inventoryItems.fields.add(new NumberField({ name: "quantity", required: true }));
    inventoryItems.fields.add(new NumberField({ name: "created_at", required: true }));
    inventoryItems.fields.add(new NumberField({ name: "updated_at", required: true }));
    dao.saveCollection(inventoryItems);
